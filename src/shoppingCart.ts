...
const product2: Product = { id: '2', name: 'Product B', price: 200 };

shoppingCart.addItem(product1);
shoppingCart.addItem(product2);

console.log(shoppingCart.getTotalPrice()); // 應該回傳 300
console.log(shoppingCart.getItemCount()); // 應該回傳 2

shoppingCart.clear();
console.log(shoppingCart.getItemCount()); // 應該回傳 0
